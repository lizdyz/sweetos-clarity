...
export const ENTITIES: Record<string, EntityDef> = {
  ...
  projects: {
    ...
    fields: [
      ...
      { key: "client_id", label: "Client (legacy)", kind: "ref", refTable: "relationships", refLabel: "name", group: "Identity" },
      { key: "execution_prompt", label: "Execution prompt", kind: "longtext", group: "Prompts" },
      { key: "prompt_status", label: "Prompt status", kind: "text", group: "Prompts" },
      ...TAXONOMY_FIELDS,
    ],
  ...
  tasks: {
    ...
    fields: [
      ...
      { key: "assignee_id", label: "Assignee", kind: "ref", refTable: "profiles", refLabel: "display_name", group: "Identity", inList: true },
      { key: "owner", label: "Owner (legacy)", kind: "select", options: TASK_OWNER, group: "Identity" },
