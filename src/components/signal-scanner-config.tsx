...
/**
 * Embed on a Domain detail page. Lets a user fire a one-off Signal Scanner
 * run that proposes new Excellence-Rubric checklist items.
 */
  ...
  return (
    <Card className="panel-raised space-y-3 p-4">
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-sm font-semibold tracking-tight">Signal Scanner</h3>
        <span className="text-[10px] uppercase tracking-[0.14em] text-muted-foreground">
          Pull external best-practice signals for this domain
        </span>
      </div>
      <div>
        ...
        <Input value={query} onChange={(e) => setQuery(e.target.value)} className="mt-1 text-sm" />
      </div>
      <div>
        <label className="text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground">
