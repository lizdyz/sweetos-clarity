...
/**
 * Canonical IA — mirrors the SweetBOS Operating Console spec.
 *   COMMAND · CLIENTS & SCOPE · WORKBENCH  always open.
 *   REVIEW · COORDINATION · LIBRARY · ADMIN collapsed by default.
...
export const SIDEBAR_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      { to: "/start", label: "Command Center", icon: Compass, hint: "Atrium · today's brief · pedestal · 8-room journey" },
      { to: "/today", label: "Today", icon: LayoutDashboard, hint: "Live working surface · my tasks · planner" },
      { to: "/planning", label: "Planning", icon: Target, hint: "Think · Seed · Decide — Missions · Journeys · Quests" },
      { to: "/capture", label: "Capture", icon: Sparkles, hint: "Drop multi-node thoughts; auto-pollinates entities" },
      { to: "/import", label: "Import", icon: Inbox, hint: "Bulk ingestion — drop a folder, we classify and route" },
      { to: "/notifications", label: "Notifications", icon: Bell, hint: "Alerts, pings, mentions, review requests" },
    ],
  },
  {
    label: "Clients & Scope",
    ...
    items: [
      { to: "/relationships", label: "Clients / Prospects", icon: Users, hint: "Orgs you work with" },
      { to: "/people", label: "People", icon: Users, hint: "Contacts within those relationships" },
      { to: "/engagement-plans", label: "Engagements", icon: Send, hint: "Scoped containers — Plan → Services → Sessions" },
      ...
      { to: "/sweetcycle", label: "SweetCycle", icon: Map, hint: "Active-relationship 8-room journey" },
    ],
  },
  {
    label: "Workbench",
    ...
    items: [
      { to: "/sandbox", label: "Sandbox", icon: FlaskConical, hint: "Frame & route — triage raw ideas" },
      { to: "/operate/ocda", label: "OCDA Cockpit", icon: Brain, hint: "Observe · Choose · Decide · Act" },
      { to: "/flightdeck", label: "Flightdeck", icon: Map, hint: "Cross-relationship operator cockpit" },
      { to: "/sweetscan", label: "SweetScan", icon: Radar, hint: "Outside-in intelligence — radar + signal inbox" },
      { to: "/sessions", label: "Sessions", icon: Calendar, hint: "All Mirror / Map / Machine / Sync sessions" },
      { to: "/projects", label: "Projects", icon: Workflow },
      { to: "/tasks", label: "Tasks", icon: ListChecks, hint: "Atomic executable work" },
      { to: "/sparks", label: "Sparks", icon: Sparkles, hint: "Atomic system-generated nudges" },
      { to: "/campaigns", label: "Campaigns", icon: Megaphone },
      { to: "/decisions", label: "Decisions", icon: FileText, hint: "Logged choices & rationale" },
      { to: "/decisions/open", label: "Open Decisions", icon: Scale, hint: "Calibration queue" },
      { to: "/risks", label: "Risks", icon: Flag, hint: "Threats to quality/trust/delivery — owner + mitigation" },
      { to: "/delegation", label: "Delegation", icon: GitBranch, hint: "Work to hand off" },
      { to: "/measures", label: "Measures", icon: Gauge, hint: "Objectives, KRs, KPIs, CSFs" },
    ],
  },
  {
    label: "Review",
    caption: "Rollups · cross-system health",
    collapsible: true,
    items: [
      { to: "/portfolio", label: "Portfolio", icon: LayoutGrid, hint: "Cross-system health — derived, no records" },
      { to: "/roadmap", label: "Roadmap", icon: TrendingUp, hint: "Forward view across engagements" },
      { to: "/metrics", label: "Metrics", icon: BarChart3, hint: "Measure health by domain/tenet" },
      { to: "/capacity", label: "Capacity", icon: Activity, hint: "Operator load forecast" },
    ],
  },
  {
    label: "Coordination",
    caption: "Comms · calendar · operators",
    collapsible: true,
    items: [
      { to: "/calendar", label: "Calendar", icon: Calendar, hint: "Visual time view" },
      { to: "/operators", label: "Operators / Team", icon: Bot, hint: "Humans · workflows · AI agents" },
      { to: "/messages", label: "Messages", icon: MessageSquare, hint: "Threads tied to records — internal vs client" },
    ],
  },
  {
    label: "Library",
    ...
    items: [
      ...
      { to: "/personas", label: "Personas", icon: Users, hint: "Buyer archetypes / external calibration lens" },
      { to: "/outcomes", label: "Outcomes", icon: Target, hint: "Aspired vs Actual result tracking" },
      { to: "/library/jtbd", label: "Jobs-to-be-done", icon: TargetIcon, hint: "Standing role responsibilities" },
      { to: "/library/ktis", label: "KTIs", icon: Radar, hint: "Forward-facing signal trackers" },
      { to: "/documents", label: "Documents / Assets", icon: FileText, hint: "Briefs, deliverables, reusable assets" },
      { to: "/evidence", label: "Evidence", icon: FileSearch, hint: "Proof, source, rationale — confidence-rated" },
      { to: "/insights", label: "Insights", icon: Lightbulb, hint: "Lessons that trigger improvements" },
  ...
  {
    label: "Admin",
    caption: "Control panel · rubrics · audit",
    collapsible: true,
    items: [
      { to: "/settings/canon", label: "Entity Canon", icon: Sparkles, hint: "What perfection looks like per entity" },
      { to: "/settings/prompts", label: "Prompt Console", icon: Wand2, hint: "Non-lens AI prompts" },
      ...
      { to: "/audit", label: "Audit Trail", icon: ShieldCheck, hint: "Every meaningful change — who, when, what" },
