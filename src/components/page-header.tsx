 ...
 *
 * NOTE: The page-level Capture button has been moved to the topbar (`<TopbarCaptureButton/>`).
 * It auto-detects the current page's entity kind + id from the URL, so every route gets
 * contextual capture without each page mounting its own button.
 */
